...
if __name__ == "__main__":
    ...
    sorted_chunks = faiss_wrapper.search_for_chunks(query, top_k=5)
    scores = faiss_wrapper.search_for_scores(query, top_k=len(text_chunk))
    sorted_chunks_with_scores = faiss_wrapper.search_for_chunks_with_scores(query, top_k=5)
    print(sorted_chunks)
    print(scores)
